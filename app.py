...
#fig = px.line(df, x=Inflow_Data['Time'], y=Inflow_Data[flow_river])
fig= go.Figure(go.Scatter(x=Inflow_Data['Time'], y=Inflow_Data[flow_river],showlegend= False),row=1, col=1)
